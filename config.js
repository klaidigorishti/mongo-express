...
if (process.env.VCAP_SERVICES) {
  ...
  mongo = {
    ...
    connectionString: process.env.ME_CONFIG_MONGODB_SERVER ? 'mongodb://localhost:27017/moodboard' : process.env.ME_CONFIG_MONGODB_URL,
    //connectionString: process.env.ME_CONFIG_MONGODB_SERVER ? 'mongodb://ds121575.mlab.com:21575/moodboard' : process.env.ME_CONFIG_MONGODB_URL,
  };
}
...
module.exports = {
  mongodb: {
    ...
    connectionString: mongo.connectionString || 'mongodb://admin:baufritzadmin@localhost:27017/moodboard',
    //connectionString: mongo.connectionString || 'mongodb://admin:baufritzadmin@ds121575.mlab.com:21575/moodboard',
    ...
    admin: process.env.ME_CONFIG_MONGODB_ENABLE_ADMIN ? process.env.ME_CONFIG_MONGODB_ENABLE_ADMIN.toLowerCase() === 'false' : false,
    ...
    adminPassword: process.env.ME_CONFIG_MONGODB_ADMINPASSWORD || 'baufritzadmin',
  ...
  useBasicAuth: process.env.ME_CONFIG_BASICAUTH_USERNAME !== 'true',

  basicAuth: {
    username: process.env.ME_CONFIG_BASICAUTH_USERNAME || 'admin',
    password: process.env.ME_CONFIG_BASICAUTH_PASSWORD || 'baufritzadmin',
  },
  ...
  options: {
    ...
    collapsibleJSONDefaultUnfold: "all",
